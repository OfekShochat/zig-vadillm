...
pub const VTable = struct {
    getAllocatableOperands: *const fn (self: *const anyopaque, *std.ArrayList(regalloc.Operand)) std.mem.Allocator.Error!void,
    // TODO:
    // regTypeForClass: *const fn (regalloc.RegClass) types.Type,
    emit: *const fn (self: *const anyopaque, *std.io.AnyWriter, std.AutoArrayHashMap(regalloc.VirtualReg, regalloc.Allocation)) anyerror!void,
